...
public class DemoController {
	...
	public String deleteallwish(@RequestParam("userId") int userId,Authentication auth, Model theModel) {
		
        String userName = auth.getName();
		
		userId = artshopservice.getIntUsers(userName);
	...
	public String deleteAllcart(@RequestParam("userId") int userId,Authentication auth, Model theModel) {
	     String userName = auth.getName();
